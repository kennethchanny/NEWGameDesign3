...
namespace TarodevController {
    ...
    /// </summary>
    public class PlayerControllerTurotial : MonoBehaviour, IPlayerController {
        ...
        private void CalculateJumpApex() {
            if (!_colDown) {
                ...
                _apexPoint = Mathf.InverseLerp(_jumpApexThreshold, 0, Mathf.Abs(GetVelocity().y));
        ...
        private void CalculateJump() {
            ...
            if (!_colDown && Input.JumpUp && !_endedJumpEarly && GetVelocity().y > 0) {
